                        ...
                        <td class="px-6 py-4">
                            ...
                            @else
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('admin.work-order.print', $record->id) }}" target="_blank"
                                        class="inline-flex items-center gap-1.5 border border-gray-200 text-gray-600 text-xs font-medium px-3 py-1.5 rounded-lg hover:bg-gray-50 transition">
